...
### ❌ Lỗi: "AddressLimitExceeded: Maximum number of addresses reached"

**Nguyên nhân:** AWS Free Tier chỉ cho phép 5 Elastic IPs per region

**Giải pháp:**

**Option 1: Release unused Elastic IPs (Khuyến nghị)**
```bash
cd DevOps_Final
...
**Option 3: Terminate unused EC2 instances**
```bash
# List instances
...
# Terminate instance (releases associated EIP)
aws ec2 terminate-instances --instance-ids <instance-id>
```

Sau khi release EIPs, re-run Terraform apply.

### ❌ Lỗi: "AlreadyExistsException: KMS alias already exists"

**Nguyên nhân:** Resources từ lần deploy trước vẫn còn tồn tại

**Giải pháp:**

**Option 1: Chạy cleanup script (Khuyến nghị)**
```bash
cd DevOps_Final
...
**Option 3: Full Terraform destroy**
```bash
cd terraform
terraform destroy -var="key_name=productx-key"
```

Sau khi cleanup, đợi 2-3 phút rồi re-run Terraform apply.
